...
// Telemetry Modes for use with CCI_CMD_SYS_SET_TELEMETRY
typedef enum {
...
// FFC Mode Control for use with CCI_CMD_SYS_SET_FFC_SHUTTER_MODE
typedef enum {
	LEP_SYS_FFC_SHUTTER_MODE_MANUAL,
	LEP_SYS_FFC_SHUTTER_MODE_AUTO,
	LEP_SYS_FFC_SHUTTER_MODE_EXTERNAL,
	LEP_SYS_FFC_SHUTTER_MODE_END
} cci_ffc_shutter_mode_t;
